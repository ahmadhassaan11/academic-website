  ...
  return (
    <div className="p-8">
      ...
      <section className="mb-8">
        ...
        <div className="mb-4">
          <h3 className="text-lg font-semibold">Fidelity in Zero-Deforestation Supply Chains (joint with M. Skidmore, H. Gibbs, L. Rausch)</h3>
          <p className="italic">[Draft coming soon!]</p>
        </div>
        <div className="mb-4">
          <h3 className="text-lg font-semibold">Property Rights and the Dynamics of Deforestation</h3>
        </div>
      </section>
    </div>
  );
