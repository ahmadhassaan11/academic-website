  ...
  return (
    <div className="p-8">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-2">Courses taught:</h2>
        <div className="mb-4">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-2">Teaching evaluations available upon request. Some quotes from the reports:</h2>
        <ul className="list-disc list-inside ml-5">
          <li className="mb-4">
